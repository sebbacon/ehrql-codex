...
DOCS=(
  "reference-cheatsheet.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/reference/cheatsheet.md"
  "how-to-examples.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/examples.md"
  "how-to-define-population.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/define-population.md"
  "how-to-dummy-data.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/dummy-data.md"
  "how-to-dummy-measures-data.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/dummy-measures-data.md"
  "reference-language.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/reference/language.md"
  "how-to-assign-multiple-columns.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/assign-multiple-columns.md"
  "how-to-test-dataset-definition.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/test-dataset-definition.md"
  "how-to-parameterise-ehrql.md|https://raw.githubusercontent.com/opensafely-core/ehrql/main/docs/how-to/parameterise-ehrql.md"
)

for entry in "${DOCS[@]}"; do
  IFS="|" read -r filename url <<<"${entry}"
  curl -fsSL "${url}" -o "${UPSTREAM_DIR}/${filename}"
done

cat > "${REF_DIR}/source-index.md" <<'EOF'
